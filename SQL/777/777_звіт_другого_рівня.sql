USE [db_archive]
GO
/****** Object:  StoredProcedure [777].[479556726_output_form]    Script Date: 14.12.2022 10:06:54 ******/
SET ANSI_NULLS ON
GO
...
BEGIN -- перший рівень процедури
 --   SET @date_for = '20221130' --лише для тестування, пізніше закоментити або видалити
